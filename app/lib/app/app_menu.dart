...
const List<MenuGroup> kAppMenu = [
  MenuGroup(label: 'Create Vouchers', icon: Icons.add_circle_outline, items: [
    ...
    MenuEntry(key: 'new-sales-order', label: 'Sales Order', icon: Icons.shopping_cart_outlined, module: 'sales-orders', create: true),
    ...
    MenuEntry(key: 'new-po', label: 'Purchase Order', icon: Icons.local_shipping_outlined, module: 'purchase-orders', create: true),
  ...
  MenuGroup(label: 'Sales', icon: Icons.trending_up, items: [
    ...
    MenuEntry(key: 'sales-orders', label: 'Sales Order', icon: Icons.shopping_cart_outlined, module: 'sales-orders'),
    MenuEntry(key: 'dely-notes', label: 'Delivery Note', icon: Icons.local_shipping_outlined, module: 'delivery-notes'),
  ...
  MenuGroup(label: 'Purchase', icon: Icons.shopping_bag_outlined, items: [
    ...
    MenuEntry(key: 'purch-orders', label: 'Purchase Order', icon: Icons.local_shipping_outlined, module: 'purchase-orders'),
    MenuEntry(key: 'recpt-notes', label: 'Receipt Note', icon: Icons.move_to_inbox_outlined, module: 'receipt-notes'),
  ...
  MenuGroup(label: 'Cash & Bank', icon: Icons.savings_outlined, items: [
    MenuEntry(key: 'cash', label: 'Cash', icon: Icons.money, module: 'cash-bank'),
  ...
  MenuGroup(label: 'Items', icon: Icons.inventory_2_outlined, items: [
    ...
    MenuEntry(key: 'stock-journals', label: 'Stock Journal', icon: Icons.inventory_outlined, module: 'stock-journal'),
    MenuEntry(key: 'physical-stock', label: 'Physical Stock', icon: Icons.checklist_outlined, module: 'physical-stock'),
  ]),
