...
const MENU_TREE = [
    ...
    { label: 'Create Vouchers', icon: 'fa-plus', items: [
        ...
        { key: 'new-stock-jrnl',  label: 'Stock Journal',    icon: 'fa-boxes-packing',     href: '/stock-journals/create', module: 'stock-journal' },
        { key: 'new-phys-stock',  label: 'Physical Stock',   icon: 'fa-clipboard-list',    href: '/physical-stock/create', module: 'physical-stock' },
