...
const MIG = path.join(__dirname, '..', 'db', 'migrations_tenant', '20260805200000_purchase_orders.js');

test('the purchase-order migration exists and exports up/down', () => {
...
test('it declares every column the module needs', () => {
    ...
    for (const col of ['order_no', 'order_date', 'due_on', 'ledger_name', 'order_status',
                       'supplier_id', 'converted_invoice_id', 'tally_voucher_type', 'tally_optional',
